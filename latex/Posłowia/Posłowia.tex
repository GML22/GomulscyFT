...
pokoleń, po~tym, jak jego przodkowie najprawdopodobniej z~własnej woli
opuścili rodzinne Dziewule. Domem, który nie~był im~przez nikogo dany,
...
z~nowymi sąsiadami w~ramach spółki \emph{Desna}. Zobowiązania, które pozwoliły
im~nie tylko pierwszy raz od~pokoleń nabyć własne miejsce na~ziemi, ale
również~-- a~być może przede wszystkim~-- odzyskać pełną podmiotowość
w~strukturach odradzającej się Polski.
