...
Zmieniało się także główne źródło utrzymania członków rodziny Gomulskich.
Jan Gomoła, jego synowie Piotr Franciszek i~Andrzej, a~także syn Andrzeja,
Feliks, byli wiejskimi kowalami. Pełnili tę~rolę przez ponad sto lat kolejno
w~Rudzienku, Zamieniu, Grzebowilku oraz~Anielinie, aż~do~lat dwudziestych
XX~wieku. Dalsi potomkowie Jana Gomoły utrzymywali się już przede wszystkim
z~uprawy ziemi. Taka sytuacja miała miejsce aż~do~połowy XX~wieku, kiedy
to~pracę na~roli zaczęli łączyć z~zatrudnieniem w~zakładach przemysłowych
powojennej Warszawy. Praca poza gospodarstwem rolnym stopniowo zaczęła
dominować nad obowiązkami w~gospodarstwie, aż~w~końcu, na~początku XXI~wieku,
już tylko nieliczni potomkowie Jana Gomoły trudnili się rolnictwem.
...
katalizatorami tych zmian wydają~się dwa procesy historyczne: uwłaszczenie
ludności chłopskiej w~drugiej połowie XIX~wieku oraz~stopniowe odzyskiwanie
przez Polskę niepodległości na~początku XX~wieku. W~tym okresie wiele rodzin
chłopskich, w~tym również rodzina Gomulskich, zyskało własną ziemię, stałe
miejsce zamieszkania oraz dostęp do~pierwszych zrębów edukacji dla swoich
dzieci. Suma przytoczonych powyżej procesów historycznych przyczyniła się
do~poprawy perspektyw zawodowych kolejnych pokoleń, wzrostu poziomu ich
wykształcenia oraz istotnego awansu społecznego, które trwają nieprzerwanie
aż~do~dziś.

\emph{Desna} na~przełomie XIX i~XX~wieku stała się więc stabilnym domem dla
dużej części potomków Jana Gomoły~-- pierwszym takim miejscem od~wielu
pokoleń, po~tym, jak jego przodkowie najprawdopodobniej opuścili rodzinne
Dziewule. Domem, który nie~był im~przez nikogo dany, ale~który sami wybudowali
i~wyposażyli dzięki ciężkiej pracy oraz wielkiemu poświęceniu, miesiąc
po~miesiącu spłacając zobowiązania zaciągnięte wspólnie z~nowymi sąsiadami
w~ramach spółki \emph{Desna}. Zobowiązania, które pozwoliły im~nie tylko
pierwszy raz od~pokoleń nabyć własne miejsce na~ziemi, ale również~-- a~być
może przede wszystkim~-- odzyskać pełną podmiotowość w~strukturach
...
\begin{flushright}
\emph{Mateusz Gomulski, 25~września 2026~r.} \\
