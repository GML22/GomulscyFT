...
przemysłowych powojennej Warszawy. Praca poza gospodarstwem rolnym stopniowo
zaczęła dominować nad obowiązkami w~gospodarstwie, aż~w~końcu, na~początku
XXI~wieku, już tylko nieliczni potomkowie Jana Gomoły trudnili się rolnictwem
w~celach innych niż~wyłącznie hobbystyczne.

Przez ostatnie trzysta lat istotnej ewolucji uległ również status społeczny
członków rodziny Gomulskich~-- od~korzeni wśród zubożałej drobnej szlachty
zagrodowej ziemi łukowskiej, poprzez chłopskich rzemieślników wschodniej
części Mazowsza, wolnych chłopów środkowego Mazowsza i~podwarszawskich
chłoporobotników, aż~po~pełnoprawnych przedstawicieli polskiej klasy średniej
zamieszkujących wschodnie przedmieścia stolicy. Historia rodziny Gomulskich,
jak~w~soczewce, pokazuje, jak bardzo zmieniła się Polska na~przestrzeni
ostatnich trzech wieków, przy~czym najsilniejszymi katalizatorami tych zmian
wydają~się dwa procesy historyczne: uwłaszczenie ludności chłopskiej w~drugiej
połowie XIX~wieku oraz~stopniowe odzyskiwanie przez Polskę niepodległości
na~początku XX~wieku. W~tym okresie wiele rodzin chłopskich, w~tym również
rodzina Gomulskich, zyskało własną ziemię, stałe miejsce zamieszkania oraz
dostęp do~pierwszych zrębów edukacji dla swoich dzieci. Suma przytoczonych
powyżej procesów historycznych przyczyniła się do~poprawy perspektyw
zawodowych kolejnych pokoleń, wzrostu poziomu ich wykształcenia oraz istotnego
awansu społecznego, które trwają, na~szczęście, nieprzerwanie aż~do~dziś.
...
pokoleń, po~tym, jak jego przodkowie opuścili rodzinne Dziewule. Domem, który
nie~był im~przez nikogo dany, ale~który sami wybudowali i~wyposażyli dzięki
ciężkiej pracy oraz wielkiemu poświęceniu, miesiąc po~miesiącu spłacając
zobowiązania zaciągnięte wspólnie z~nowymi sąsiadami w~ramach spółki
\emph{Desna}. Zobowiązania, które pozwoliły im~nie tylko pierwszy raz
od~pokoleń nabyć własne miejsce na~ziemi, ale również~-- a~być może przede
wszystkim~-- odzyskać pełną podmiotowość w~strukturach odradzającej się
Polski.
