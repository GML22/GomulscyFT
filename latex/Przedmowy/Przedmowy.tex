...
swoje niż cudze przeżycia. Dziadek Stasiek\indeksosoby{Stanisław}{Gomulski}{1926}{Desno}
...
wraz z~moim starszym bratem Krzyśkiem\indeksosoby{Krzysztof}{Gomulski}{1988}{Warszawa} 
oraz bratem ciotecznym Łukaszem\indeksosoby{Łukasz}{Kowalczyk}{1990}{Warszawa},
z~racji, iż~mieszkaliśmy blisko nich, bardzo często im~w~tych zajęciach mimowolnie
towarzyszyliśmy. Czasami dziadkowie organizowali również bardziej poważne
prace jak sianokosy, żniwa czy sadzenie / zbieranie ziemniaków, do~których
angażowana była już praktycznie cała nasza rodzina. Widzę to~teraz w~moich
rodzicach Andrzeju\indeksosoby{Andrzej Włodzimierz}{Gomulski}{1963}{Otwock}
...
również istotną częścią historii matki mojej babci -- Magdaleny
...
ludzi starszych -- oboje z~dziadkiem zmarli niestety właśnie w~marcu, dziadek
9~lat po~babci w~marcu 2023~roku, dożywając aż 96~lat i~333~dni. Dziadek
Stasiek do~końca swoich dni powtarzał ulubione przysłowie: \emph{Śmierć
i~żona przeznaczona}.}, to~też nigdy nie poznałem żadnych krewnych ze~strony
tych rodzin, a~krewnych ze~strony rodziny Gomulskich mam całe mnóstwo. Być
może kiedyś zdecyduję się napisać też coś więcej o~historii rodzin Poziemskich
...
oraz te zapisane tuszem w~starych dokumentach. Powstała również
po~to~by~odpowiedzieć na liczne pytania, które nurtowały mnie, czasem już
od~wczesnych lat mojego dzieciństwa:
...
Teraz, gdy moi dziadkowie już nie żyją, pryszedł czas, żebym zebrał
...
kolejnych, bardziej już cyfrowych pokoleń.
