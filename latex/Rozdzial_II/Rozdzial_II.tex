...
Gomoła / Gomolak / Gomuła / Gomolik. \textbf{To co wiadomo na pewno to fakt,
iż Antoni Gomoła i~Petronella Sokół są protoplastami rodziny Gomulskich, nie 
...
Gomolaka (Gomoły), z~aktu jego zgonu wiadomo, iż urodził się on prawdopodobnie 
...
o~około 30~kilometrów na zachód Garwolin. Wieś ta należała w~tamtym czasie do
...
w~bardzo młodym wieku, albo z~powodu chorób zakaźnych\footnote{Drzewo
genealogiczne najbliższej rodziny Antoniego i~Petronell Gomułów zostało
zaprezentowane w~\hyperref[sec:drzewo_agomola]{załączniku numer I}~do
niniejszej książki.}.
...
dworskiego Marcina Federowicza (patrz: ryc. \ref{fig:gomola3_lubgens}).
Co~więcej, ojcem chrzestnym najstarszego syna Antoniego i~Petronelli,
Wojciecha, został Tomasz Rzewuski, chorąży łukowski, jedyny dziedzic pokaźnego
...
rodzicami byli prawdopodobnie\footnote{Nie można mieć całkowitej pewności, że 
